I'm into C#, SQL Server, .NET Core, Blazor, and Azure. I love relational data access, [Dapper](https://github.com/StackExchange/Dapper), and I make a couple Dapper extension libraries:
...
I'm also getting into Blazor, but much of my work here is closed source. However I am working on a general-purpose show-and-tell project [BlazorStarter](https://github.com/adamfoneil/BlazorStarter).
